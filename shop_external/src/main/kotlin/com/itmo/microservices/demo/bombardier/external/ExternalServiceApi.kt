...
interface ExternalServiceApi {
    ...
    suspend fun confirmDelivery(deliveryId: UUID, userId: UUID)
    suspend fun getItems(catalogueId: UUID, userId: UUID, available: Boolean): List<CatalogItem>
    data class Catalogue(
        val id: UUID,
        val name: String
    )
    suspend fun createCatalogue(userId: UUID): Catalogue
    suspend fun getAvailableItems(userId: UUID, catalogueId: UUID) = getItems(catalogueId, userId, true)
    suspend fun createItemInCatalogue(userId: UUID, catalogueId: UUID)
    ...
    suspend fun setDeliveryTime(userId: UUID, orderId: UUID, slot: Duration): DeliveryInfoRecord
